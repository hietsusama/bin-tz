<?php
/*
 * From ： https://github.com/getbin/bin-tz
 */
error_reporting(0); //抑制所有错误信息
@header("content-Type: text/html; charset=utf-8"); //语言强制
ob_start();
date_default_timezone_set('Asia/Beijing');//此句用于消除时间差
...
<head>
    ...
    function displayData(dataJSON)
    {
        ...
        asd ++;
        document.getElementById('stat1').innerText = asd;
    }
    -->
    </script>
    <style>
        div.wall { width: 1000px; margin:10px auto; }
        table { font-size:90%; }
    </style>
</head>
<body>
    <div id="page" class="wall">
          ...
          <tr>
                ...
                <td colspan="5">
                  ...
                  <span id="memPercent"><?php echo $memPercent;?></span>
                    <div class="progress">
                      <div id="barmemPercent" class="progress-bar progress-bar-striped" role="progressbar progress-bar-success" aria-valuenow="<?php echo $memPercent?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $memPercent?>;">
        ...
        ?>
                  ...
                  %	| Buffers缓冲为  <span id="Buffers"><?php echo $mb;?></span>
                    <div class="progress">
                      <div id="barmemCachedPercent" class="progress-bar progress-bar-striped" role="progressbar" aria-valuenow="<?php echo $memCachedPercent?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $memCachedPercent?>;">
                  ...
                  %
                    <div class="progress">
                      <div id="barmemRealPercent" class="progress-bar progress-bar-striped" role="progressbar" aria-valuenow="<?php echo $memRealPercent?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $memRealPercent?>;">
    ...
    <?php endif; ?>
        ...
        <table class="table table-hover table-bordered">
            <thead class="thead-dark">
            <tr>
                <th colspan="2">链接详情</th>
            </tr>
            </thead>
                <tr>
                    <td width="50%">已连接时间:  <span id="stat1"></span> 秒</td>
                    <td width="50%">访问次数: <span id="busuanzi_container_site_pv"><span id="busuanzi_value_site_pv" style="color: coral"></span>次</span></td>
                </tr>
        </table>
    </div>
